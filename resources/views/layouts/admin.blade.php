...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | Klasemen Bola</title>
    ...
    <meta name="apple-mobile-web-app-title" content="Klasemen Bola">
            ...
            <div class="app-footer">
                <div class="p-2 text-xs">
                    <div class="pull-right text-muted py-1">
                        &copy; Copyright <strong>Klasemen Bola</strong> <span class="hidden-xs-down">- Built with Love
                            v1.1.3</span>
